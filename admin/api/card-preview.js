...
export default async function handler(req, res) {
    try {
        ...
        // 2. If requested by a CRAWLER (WhatsApp, Facebook, etc.): Return SSR HTML focused ONLY on the Card Image
        if (isBot) {
...
<head>
    ...
    <!-- Open Graph: Image-Only Preview for WhatsApp & Social Media -->
...
<body>
    <a href="${ogPageUrl}"><img src="${ogImageUrl}" alt="Card" /></a>
</body>
</html>`;
