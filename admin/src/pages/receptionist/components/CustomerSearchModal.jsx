                                                                ...
                                                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
                                                                    {Array.from({ length: totalStamps }).map((_, idx) => {
                                                                        ...
                                                                        return (
                                                                            ...
                                                                            >
                                                                                <div
                                                                                    title={`Stamp ${idx + 1}: ${isPaid ? 'Click to Edit' : (isCurrentNext ? 'Next Stamp in Line • Click to Process' : `Locked • Complete Stamp #${firstUnprocessedIndex + 1} first`)}${levelData?.reward ? ` • ${levelData.reward}` : ''}${hasFree ? ` (Free: ${freePerkText || 'Free Perk'})` : ''}`}
                                                                                    style={{
                                                                                        width: 40,
                                                                                        height: 40,
