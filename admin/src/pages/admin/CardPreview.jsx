...
export default function CardPreview() {
    ...
    */
    ...
    const fetchStampCards = async () => {
        ...
        try {
            ...
            console.log(
                'CardPreview: Fetching stamp card ID:',
                id
            )
            ...
            console.log(
                'CardPreview Stamp Card:',
                item
            )


            const totalStamps =
                Number(item.number_of_stamps) || 8


            const stampLevels =
                Array.isArray(item.StampLevels)
                    ? item.StampLevels
                    : []
            ...
            */
            ...
            console.error(
                'Error fetching stamp card from API:',
                err
            )
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is only for the browser page title.
    | WhatsApp OG metadata is handled separately on the server.
    |--------------------------------------------------------------------------
    */
                            ...
                            >
                                ...
                                {Array.from({
                                    ...
                                    */
                                        ...
                                        rewardItem &&
                                        rewardItem.type === 'Paid' &&
                                        rewardItem.icon
                                    ) {

                                        iconMarkup = (
                                            <i
                                                className={`fas ${rewardItem.icon}`}
                                                style={{
                                                    fontSize:
                                                        '0.8rem'
                                                }}
                                    ...
                                    return (
                                        ...
                                        <div
                                            ...
                                            style={{
                                                ...
                                                borderRadius:
                                                    `${card.stamp_radius ?? 50}%`,

                                                border:
                                                    `2px solid ${
                                                        card.stampBorderColor ||
                                                        '#FFFFFF'
                                                    }`,
