    ...
    <footer className="bg-slate-900 border-t border-slate-800 text-slate-400 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          {/* Logo Only Section - No company name text */}
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium">
              <li><a href="#features" onClick={() => setActiveTab('home')} className="hover:text-teal-400 transition-colors">Features</a></li>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-medium">
              <li className="text-slate-400 font-mono text-xs">alex@firstloop.com</li>
            </ul>

            <div className="flex items-center gap-3 pt-2">
              <a href="https://www.instagram.com/firstpass.co" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-teal-600 hover:text-white transition-all" aria-label="Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/firstpass.co" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-teal-600 hover:text-white transition-all" aria-label="Instagram">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
