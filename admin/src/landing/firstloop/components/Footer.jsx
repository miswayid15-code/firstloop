...
export const Footer = () => {
  ...
  return (
    <footer className="border-t border-teal-600/40 pt-16 pb-12 transition-colors duration-300 text-white" style={{ backgroundColor: '#14b8a6' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs font-semibold text-white/80">
              <li className="font-mono text-xs text-white font-bold">alex@firstloop.com</li>
            </ul>

            <div className="flex items-center gap-3 pt-2">
              <a href="#" className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-white hover:bg-white hover:text-teal-800 transition-all shadow-sm" aria-label="Facebook">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-white hover:bg-white hover:text-teal-800 transition-all shadow-sm" aria-label="Instagram">
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
        ...
        <div className="pt-8 border-t border-teal-400/30 flex flex-col sm:flex-row items-center justify-between text-xs text-white/90 gap-4 font-semibold">
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1">
            ...
            <button 
              ...
              className="text-white hover:text-teal-100 transition-colors cursor-pointer font-extrabold"
            >
              Merchant Login
            </button>
          </div>
