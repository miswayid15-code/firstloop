const sendOtp = (otp, type, name = 'User') => {
    ...
    const config =
        type === 'merchant'
            ? {
                ...
                subtitle: 'One more step to unlock your merchant dashboard.',
            ...
            : type === 'customer'
                ? {
                    ...
                    subtitle: 'One more step to unlock your rewards profile.',
                ...
                : {
                    ...
                    subtitle: 'One more step to get your account up and running.',
    ...
    <div style="max-width:600px;margin:40px auto;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 25px 70px rgba(0,0,0,0.07);border:1px solid #eef2f5;">
        ...
        <div style="padding:45px 50px;color:#333333;background:#ffffff;">
            ...
            <p style="
                    ...
                    line-height:1.8;
                    ">
                Thank you for choosing <strong>FirstPass</strong>. To protect your account and complete your registration, please verify your email address using the One-Time Password below.
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:30px; border-collapse: separate; border-spacing: 0;">
                <tr>
                    ...
                    <td width="48%" valign="top" style="
                        ...
                        <div style="color:#64748b; line-height:1.6; font-size:13.5px;">
                            If you did not initiate this FirstPass registration signup, you can safely disregard and delete this email.
                        </div>
                    </td>
                </tr>
            </table>
